...
class DisMap extends Component {
  ...
  state = {
    favPlaces: [ // Our Favorite DW Places
      {name: "Splash Mountain", venueid: "4b901bfff964a5202e7633e3", location: {lat: 28.419425, lng: -81.585062}},
      {name: "Space Mountain", venueid: "4b099894f964a520141a23e3", location: {lat: 28.419278, lng: -81.578037}},
      {name: "Haunted Mansion", venueid: "4b099894f964a520141a23e3", location: {lat: 28.420424, lng: -81.582883}},
      {name: "Cinderella's Royal Table", venueid: "4b994d2af964a520607135e3", location: {lat: 28.419722, lng: -81.581232}},
      {name: "Be Our Guest", venueid: "4db98498cda10f31e62de917", location: {lat: 28.421364, lng: -81.580714}},
    ],
    markers: [],
  ...
  initMap = () => {
    ...
    this.state.favPlaces.forEach((location) => {
